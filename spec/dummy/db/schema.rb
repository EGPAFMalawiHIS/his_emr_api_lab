...
ActiveRecord::Schema.define(version: 20_210_807_111_531) do
  ...
  create_table 'encounter', primary_key: 'encounter_id', force: :cascade do |t|
    ...
    t.index %w[encounter_datetime patient_id encounter_type], name: 'idx_person_encounters_by_date'
    ...
    t.index %w[patient_id encounter_type], name: 'idx_person_encounters'
  ...
  create_table 'global_property', force: :cascade do |t|
    ...
    t.text 'property_value', limit: 16_777_215
    t.text 'description'
    t.string 'uuid', limit: 38, null: false
  ...
  create_table 'location_tag_map', primary_key: %w[location_id location_tag_id], force: :cascade do |t|
  ...
  create_table 'obs', primary_key: 'obs_id', force: :cascade do |t|
    ...
    t.index %w[obs_datetime person_id concept_id value_coded], name: 'idx_person_obs_answers_by_date'
    t.index ['obs_datetime'], name: 'obs_datetime_idx'
    t.index ['obs_group_id'], name: 'obs_grouping_id'
    t.index ['order_id'], name: 'obs_order'
    t.index %w[person_id concept_id value_coded], name: 'idx_person_obs_answer'
    t.index %w[person_id obs_group_id value_coded], name: 'idx_obs_grouping'
  ...
  create_table 'orders', primary_key: 'order_id', force: :cascade do |t|
    ...
    t.index %w[start_date patient_id concept_id order_type_id], name: 'idx_order'
  ...
  create_table 'person_name_code', primary_key: 'person_name_code_id', force: :cascade do |t|
    ...
    t.index %w[given_name_code family_name_code], name: 'given_family_name_code'
  ...
  create_table 'role_privilege', primary_key: %w[privilege role], force: :cascade do |t|
    t.string 'role', limit: 50, default: '', null: false
    t.string 'privilege', limit: 50, default: '', null: false
  end

  create_table 'role_role', primary_key: %w[parent_role child_role], force: :cascade do |t|
  ...
  create_table 'user_property', primary_key: %w[user_id property], force: :cascade do |t|
    t.integer 'user_id', default: 0, null: false
    t.string 'property', limit: 100, default: '', null: false
    t.text 'property_value'
  end

  create_table 'user_role', primary_key: %w[role user_id], force: :cascade do |t|
    t.integer 'user_id', default: 0, null: false
    t.string 'role', limit: 50, default: '', null: false
  end
